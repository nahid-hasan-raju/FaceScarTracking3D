...
- **Drive API rate limits**: the tree walk is cached for 5 minutes
...
- For how the whole project actually works — architecture, what each
  file does, why some of the trickier code is written the way it is, and
  how to add new features later — see `README.md`.
